...
public class AuthorcolumnFragment extends Fragment implements NewsInterface, LoadMoreInterface {
    @Inject
    ...
    public void onNews(RequestResponse news) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                mIntent.putExtra("category", "authorcolumn");
        ...
        mNewsAdapter.addItems(mNewsList, false, true, false, false);
    ...
    public Observable<RequestResponse> getNews() {
        if (isRefreshing) {
            return mNetworkClient.getArticleList("authorcolumn", 0, 10);
        } else {
            return mNetworkClient.getArticleList("authorcolumn", offset, 10);
        }
    }
    ...
    public Observable<RequestResponse> loadMore() {
        return mNetworkClient.getLoadMoreArticleList("authorcolumn", offset, 10);
    }
    @Override
