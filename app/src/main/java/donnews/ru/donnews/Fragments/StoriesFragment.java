...
public class StoriesFragment extends Fragment implements NewsInterface, LoadMoreInterface {
    @Inject
    ...
    public void onNews(RequestResponse news) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                mIntent.putExtra("category", "stories");
        ...
        mNewsAdapter.addItems(mNewsList, false, false, true, false);
    ...
    public Observable<RequestResponse> getNews() {
        if (isRefreshing) {
            return mNetworkClient.getArticleList("stories", 0, 10);
        } else {
            return mNetworkClient.getArticleList("stories", offset, 10);
        }
    }
    ...
    public Observable<RequestResponse> loadMore() {
        return mNetworkClient.getLoadMoreArticleList("stories", offset, 10);
    }
    @Override
