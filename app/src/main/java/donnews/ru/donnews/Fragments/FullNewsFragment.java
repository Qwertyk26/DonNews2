...
public class FullNewsFragment extends Fragment implements NewsInterface, LoadMoreInterface {
    @Inject
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mNewsAdapter = new NewsAdapter(getActivity(), mRecyclerView, 50);
    ...
    public Observable<RequestResponse> getNews() {
        if (isRefreshing) {
            ...
            return mNetworkClient.getMixNews(0, 10);
        } else {
            return mNetworkClient.getMixNews(offset, 10);
        }
    }
