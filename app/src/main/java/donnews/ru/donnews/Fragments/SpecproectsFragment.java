...
public class SpecproectsFragment extends Fragment implements NewsInterface, LoadMoreInterface {
    @Inject
    ...
    public void onNews(RequestResponse news) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                mIntent.putExtra("category", "specproects");
        ...
        mNewsAdapter.addItems(mNewsList, false, false, false, true);
    ...
    public Observable<RequestResponse> getNews() {
        if (isRefreshing) {
            return mNetworkClient.getArticleList("specproects", 0, 10);
        } else {
            return mNetworkClient.getArticleList("specproects", offset, 10);
        }
    }
    ...
    public Observable<RequestResponse> loadMore() {
        return mNetworkClient.getLoadMoreArticleList("specproects", offset, 10);
    }
    @Override
