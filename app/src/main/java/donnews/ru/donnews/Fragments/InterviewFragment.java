...
public class InterviewFragment extends Fragment implements NewsInterface, LoadMoreInterface {
    @Inject
    ...
    public void onNews(RequestResponse news) {
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerItemClickListener(getActivity(), mRecyclerView, new RecyclerItemClickListener.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                ...
                mIntent.putExtra("category", "interview");
        ...
        mNewsAdapter.addItems(mNewsList, true, false, false, false);
    ...
    public Observable<RequestResponse> getNews() {
        if (isRefreshing) {
            return mNetworkClient.getArticleList("interview", 0, 10);
        } else {
            return mNetworkClient.getArticleList("interview", offset, 10);
        }
    }
    ...
    public Observable<RequestResponse> loadMore() {
        return mNetworkClient.getLoadMoreArticleList("interview", offset, 10);
    }
    @Override
